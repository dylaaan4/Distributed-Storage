...
public class Form_Connection extends javax.swing.JFrame {
    private  Server_Distributed_Interface si ;
    public Form_Connection( Server_Distributed_Interface si) {
        setSi(si);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Server_Repo/6dc6bfda42e82b400d58717f2c1b0d8a.jpg")));
        background.setText(" ");
    ...
    public Server_Distributed_Interface getSi() {
        return si;
    }

    public void setSi(Server_Distributed_Interface si) {
        this.si = si;
    }
